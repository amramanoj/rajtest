...
class VehicleDetailRecord extends StatelessWidget {

  const VehicleDetailRecord({super.key});

  @override
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 3,
      child: Scaffold(appBar: AppBar(title: const Text("Vehicle Detail Record"),),body:
 Column(children: [
          Container(
